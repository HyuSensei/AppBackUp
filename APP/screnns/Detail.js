...
const Detail =(props) => {
    ...
    const theodoi = (id_user, id_baibao) => {
        axios
        .post("http://192.168.0.106/api_newspaper-main/api/theodoi/theodoi.php", {
            id_user,
            id_baibao
        })
        .then(res => {
    ...
    const botheodoi = (id_user, id_baibao) => {
        axios
        .post("http://192.168.0.106/api_newspaper-main/api/theodoi/botheodoi.php", {
            id_user,
            id_baibao
        })
        .then(res => {
    ...
    const checkTontai=(id_user, id_baibao)=>{
        axios
        .get("http://192.168.0.106/api_newspaper-main/api/theodoi/check.php",{
            params: {
                id_user,
                id_baibao
            }
